...
public class DataSource implements javax.sql.DataSource {
    ...
    static String passwords = "Bigboss307#";
    ...
    public Connection createConnection() {
        ...
        try {
            ...
            props.put("dbName", "mysql");
            props.put("user", root);
            props.put("password", passwords);
    ...
    public boolean create(String username, String password, String email, String firstName, String lastName,
                          String phone, String middleName, String country, String city, String state, LocalDate value, String address, String zip) throws SQLException, ClassNotFoundException, InstantiationException, IllegalAccessException {
        ...
        if (rs.next()) {
            ...
            System.out.println("Successfully connected to MySQL database ");
            ps = conn.prepareStatement("insert into user (username, password, Email, first_name, last_name, Phone, middle_name, Country, City, State, Address, Zip) values (?,?,?,?,?,?,?,?,?,?,?,?)");
