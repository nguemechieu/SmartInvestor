...
public class BinanceUs extends Exchange {
    ...
    public CandleDataSupplier getCandleDataSupplier(int secondsPerCandle, TradePair tradePair) {
        return new BinanceUsCandleDataSupplier(secondsPerCandle, tradePair) {
            ...
            @Override
            public CompletableFuture<List<Trade>> fetchRecentTradesUntil(TradePair tradePair0, Instant stopAt) {
                return null;
            }
    ...
    public abstract static class BinanceUsCandleDataSupplier extends CandleDataSupplier {
        private static final ObjectMapper OBJECT_MAPPER = new ObjectMapper()
                .registerModule(new JavaTimeModule())
                .enable(SerializationFeature.WRITE_DATES_AS_TIMESTAMPS)
                .configure(DeserializationFeature.FAIL_ON_UNKNOWN_PROPERTIES, false);
        ...
        String apiKey=
                "9q3vfhm7l33rus21toc8fndupq76itje";
        String url = "https://api.binance.us/api/v3/klines";;
        ...
        public Future<List<CandleData>> get() {
            ...
            return HttpClient.newHttpClient().sendAsync(
                    ...
                    .thenApply(response -> {
                        logger.info("Binance Us response: " + response);
                        JsonNode res;
                        try {
        ...
        public abstract CompletableFuture<Optional<InProgressCandleData>> fetchCandleDataForInProgressCandle(TradePair tradePair, Instant currentCandleStartedAt, long secondsIntoCurrentCandle, int secondsPerCandle);
